<ul class="list-unstyled px-3">
    ...
    <li class="{{ Request::is('*pembayaran*') ? 'active' : ''}}"><a href="{{ route('admin.pembayaran.index') }}"><i class="bi bi-receipt-cutoff"></i>Pembayaran</a></li>
    <li class="{{ Request::is('*riwayat*') ? 'active' : ''}}"><a href="{{ route('admin.riwayat.index') }}"><i class="bi bi-clock-history"></i>Riwayat</a></li>
